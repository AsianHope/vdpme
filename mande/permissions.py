...
def generate_group_perms():
    ...
    group_perms['community_worker'] = __addperms(perms_required['publicschool_form'],group_perms['community_worker'])
	...
	#save photo
    group_perms['community_worker'] = __addperms(perms_required['save_photo'],group_perms['community_worker'])

    #teachers can:
	#add student public school history
    group_perms['teacher'] = __addperms(perms_required['publicschool_form'],group_perms['teacher'])
	...
	#save photo
    group_perms['teacher'] = __addperms(perms_required['save_photo'],group_perms['teacher'])
