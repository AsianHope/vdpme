# -*- coding: utf-8 -*-
# Generated by Django 1.11.1 on 2017-08-11 06:55
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('mande', '0036_auto_20170504_2013'),
    ]

    operations = [
        migrations.CreateModel(
            name='CurrentStudentInfo',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('student_id', models.IntegerField(unique=True, verbose_name='Stduent ID')),
                ('name', models.CharField(default=b'', max_length=64, verbose_name='Name')),
                ('date', models.DateField(verbose_name='Date of Intake')),
                ...
                ('refresh', models.DateField(default=datetime.date.today, verbose_name='Refresh Date')),
                ('age_appropriate_grade', models.IntegerField(verbose_name='Age Appropriate Grade')),
                ('at_grade_level', models.BooleanField(default=True, verbose_name='At Grade Level?')),
                ('in_public_school', models.BooleanField(default=True, verbose_name='In Public School?')),
                ('vdp_grade', models.IntegerField(choices=[(-1, 'Not Applicable'), (0, 'Not Enrolled'), (1, 'Grade 1'), (2, 'Grade 2'), (3, 'Grade 3'), (4, 'Grade 4'), (5, 'Grade 5'), (6, 'Grade 6'), (7, 'Grade 7'), (8, 'Grade 8'), (9, 'Grade 9'), (10, 'Grade 10'), (11, 'Grade 11'), (12, 'Grade 12'), (50, 'English'), (60, 'Computers'), (70, 'Vietnamese'), (999, 'No Grade / Never Studied')], verbose_name='VDP Grade')),
                ('site', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mande.School', verbose_name='Site')),
            ],
        ),
        ...
        migrations.AlterField(
            ...
            name='cohort',
            field=models.IntegerField(choices=[(-1, 'Not Applicable'), (0, 'Not Enrolled'), (1, 'Grade 1'), (2, 'Grade 2'), (3, 'Grade 3'), (4, 'Grade 4'), (5, 'Grade 5'), (6, 'Grade 6'), (7, 'Grade 7'), (8, 'Grade 8'), (9, 'Grade 9'), (10, 'Grade 10'), (11, 'Grade 11'), (12, 'Grade 12'), (50, 'English'), (60, 'Computers'), (70, 'Vietnamese'), (999, 'No Grade / Never Studied')], default=1, verbose_name='Target Grade'),
        ),
    ]
